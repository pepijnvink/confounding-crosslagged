...
## Load parameters
psi_all <- readRDS("params/main/sigmas.rds")
multi_mats <- readRDS("params/main/multi_mats.rds")
beta_all <- readRDS("params/main/betaAll.rds")
...
data_s1 <- sim_stable_R(timepoints = t,
                      ...
                      sigmaC = corr_mat,
                      seed = 42)
saveRDS(data_s1, paste0("output/main/simdat/N", N, "/scenario1_N", N, ".rds"))
rm(data_s1)
...
data_s2 <- sim_varying_R(timepoints = t,
                         ...
                         sigmaC = corr_mat,
                         seed = 42)
saveRDS(data_s2, paste0("output/main/simdat/N", N, "/scenario2_N", N, ".rds"))
rm(data_s2)
...
data_s3 <- sim_varying_R(timepoints = t,
                         ...
                         sigmaC = corr_mat,
                         seed = 42)
saveRDS(data_s3, paste0("output/main/simdat/N", N, "/scenario3_N", N, ".rds"))
rm(data_s3)
...
data_s4 <- sim_varying_R(timepoints = t,
                         ...
                         sigmaC = corr_mat,
                         seed = 42)
saveRDS(data_s4, paste0("output/main/simdat/N", N, "/scenario4_N", N, ".rds"))
rm(data_s4)
...
data_s5 <- sim_varying_R(timepoints = t,
                         ...
                         sigmaC = corr_mat,
                         seed = 42)
saveRDS(data_s5, paste0("output/main/simdat/N", N, "/scenario5_N", N, ".rds"))
rm(data_s5)
...
data_s6 <- sim_varying_R(timepoints = t,
                         ...
                         sigmaC = corr_mat,
                         seed = 42)
saveRDS(data_s6, paste0("output/main/simdat/N", N, "/scenario6_N", N, ".rds"))
rm(data_s6)
