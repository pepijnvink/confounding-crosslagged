...
data_s1 <- readRDS(paste0("output/main/simdat/N", N, "/scenario1_N", N, ".rds"))
...
saveRDS(data_s1, file = paste0("output/main/analyzed_dat/N", N, "/analyzed_scenario1_N", N, ".rds")) # analyzed data
...
saveRDS(res_s1, file = paste0("output/main/results/N", N, "/results_scenario1_N", N, ".rds")) # save results
rm(data_s1, res_s1)

# Scenario 2
data_s2 <- readRDS(paste0("output/main/simdat/N", N, "/scenario2_N", N, ".rds"))
...
saveRDS(data_s2, file = paste0("output/main/analyzed_dat/N", N, "/analyzed_scenario2_N", N, ".rds")) # analyzed data
...
saveRDS(res_s2, file = paste0("output/main/results/N", N, "/results_scenario2_N", N, ".rds")) # save results
rm(data_s2)

# Scenario 3
data_s3 <- readRDS(paste0("output/main/simdat/N", N, "/scenario3_N", N, ".rds"))
...
saveRDS(data_s3, file = paste0("output/main/analyzed_dat/N", N, "/analyzed_scenario3_N", N, ".rds")) # analyzed data
...
saveRDS(res_s3, file = paste0("output/main/results/N", N, "/results_scenario3_N", N, ".rds")) # save results
rm(data_s3)


# Scenario 4
data_s4 <- readRDS(paste0("output/main/simdat/N", N, "/scenario4_N", N, ".rds"))
...
saveRDS(data_s4, file = paste0("output/main/analyzed_dat/N", N, "/analyzed_scenario4_N", N, ".rds")) # analyzed data
...
saveRDS(res_s4, file = paste0("output/main/results/N", N, "/results_scenario4_N", N, ".rds")) # save results
rm(data_s4, res_s4)

# Scenario 5
data_s5 <- readRDS(paste0("output/main/simdat/N", N, "/scenario5_N", N, ".rds"))
...
saveRDS(data_s5, file = paste0("output/main/analyzed_dat/N", N, "/analyzed_scenario5_N", N, ".rds")) # analyzed data
...
saveRDS(res_s5, file = paste0("output/main/results/N", N, "/results_scenario5_N", N, ".rds")) # save results
rm(data_s5, res_s5)

# Scenario 6
data_s6 <- readRDS(paste0("output/main/simdat/N", N, "/scenario6_N", N, ".rds"))
...
saveRDS(data_s6, file = paste0("output/main/analyzed_dat/N", N, "/analyzed_scenario6_N", N, ".rds")) # analyzed data
...
saveRDS(res_s6, file = paste0("output/main/results/N", N, "/results_scenario6_N", N, ".rds")) # save results
options(warn = oldw)
