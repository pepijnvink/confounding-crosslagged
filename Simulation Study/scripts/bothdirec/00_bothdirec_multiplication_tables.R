...
saveRDS(sigmas, "params/bothdirec/sigmas.rds")
...
saveRDS(multi_mats, "params/bothdirec/multi_mats.rds")

saveRDS(list(beta_cont = beta_cont_s1, beta_dich = beta_dich_s1), "params/bothdirec/betaAll.rds")
