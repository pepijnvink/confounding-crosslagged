...
for(j in 1:4){
  ...
  for(i in 1:6){
    allres[[j]][[i]] <- readRDS(paste0("output/bothdirec/results/N", N, "/results_scenario", i, "_N", N, ".rds"))
...
ggsave(filename = paste0("figures/bothdirec/power/bothdirec_power_", outcome, ".png"), plot = fig, width = 9, height = 7, units = "in")
ggsave(filename = paste0("figures/bothdirec/power/bothdirec_power_", outcome, ".svg"), plot = fig, width = 9, height = 7, units = "in")