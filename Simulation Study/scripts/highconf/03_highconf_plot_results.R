...
for(i in 1:6){
  allres[[i]] <- readRDS(paste0("output/highconf/results/N", N, "/results_scenario", i, "_N", N, ".rds"))
...
plot_all
ggsave(filename = paste0("figures/highconf/png/", outcome, "/N", N, "_", outcome, ".png"), plot = plot_all, width = 9, height = 7, units = "in")
ggsave(filename = paste0("figures/highconf/svg/", outcome, "/N", N, "_", outcome, ".svg"), plot = plot_all, width = 9, height = 7, units = "in")
